...
PULONG GetKiProcessorBlock()
{
	...
	__asm {
		...
		mov		eax, fs:[0x34]				// eax = 0x83f7fc00
		add		eax, 20h					// eax = 0x83f7fc00  + 20h = 83f7fc20  
		mov		eax, [eax]					// eax = [83f7fc20] = 841c7fec 
		mov		eax, [eax]					// eax = [841c7fec] = 83f7fc28 
		mov		eax, [eax + 218h]			// eax = [83f7fc28 + 218h] = 
